...
## Command usage
Please check the [github address](https://github.com/yt6983138/PSLDiscordBot/blob/master/usage.md) (I can't fit everything in a message with maxium length of 2000 :sob:)